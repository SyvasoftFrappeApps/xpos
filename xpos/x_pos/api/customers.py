...
def get_customer_names(
	...
	if _pos_profile.get("use_server_cache") and not (limit or offset or start_after or modified_after):
...
def create_customer(
	...
	if method == "create":
		...
		if pos_profile.get("allow_duplicate_customer_names") or not is_exist:
